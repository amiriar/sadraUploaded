...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://sadra-edu.com/api/HomeEventData/data"
        );
    ...
    const fetchData2 = async () => {
      try {
        const response = await fetch(
          "https://sadra-edu.com/api/HomeContactsDetail/data"
        );
        const jsonData = await response.json();
    ...
    const fetchData4 = async () => {
      try {
        const response = await fetch(
          "https://sadra-edu.com/api/HomeComment/data"
        );
        const jsonData = await response.json();
  ...
  return (
    <>
      ...
      <div className="Contact_slider" id="maxWidth">
        ...
        <h1>
          بیش از {usePersianNumber("500")} دانش‌آموخته از مسیر خود راضی بودند
        </h1>
        ...
        <div className="contact_corporates">
          <img
            src="../../assets/logos/آب و فاضلاب استان تهران  سفید.png"
            alt="a1"
            className="logoMainPage"
            style={{ height: "85px", width: "230px" }}
          />
          <img
            src="../../assets/logos/موج پردازان البرز سفید.png"
            alt="a2"
            className="logoMainPage"
            style={{ height: "85px", width: "230px" }}
          />
          <img
            src="../../assets/logos/بیمه میهن سفید.png"
            alt="a3"
            className="logoMainPage"
            style={{ height: "85px", width: "230px" }}
          />
